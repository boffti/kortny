...
- HTML output mode omitted per HIG-239: Kortny does not serve web pages. Output is: (1) Slack mrkdwn post (always, inline), (2) uploaded .md file, (3) PDF via `styled-report-pdf` skill pairing.
